...
public class Main {
    public static void main(String[] args) {
        ...
        Human bot = new Human(3);
        Electric toyota2 = new Electric("Toyota", "Prius", 1500, "pink", 1000.0);
        Electric toyota3 = new Electric("Toyota", "Prius", 1500, "pink", 1000.0);
        bot.setCar(toyota2, 1);
        bot.setCar(toyota3, 2);


        //sortowanie
        String names[] = {"kacper", "kuba", "michał", "maciek"};
        //zestaw narzędzi do pracy z tablicami
        Arrays.sort(names);
        System.out.println(names);

        int numbers[] = {1,4,34,12,14,6,3,24,13};
        Arrays.sort(numbers);
    }
